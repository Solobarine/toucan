...
import { followUser } from "../../features/thunks/connections";
          ...
          {notification.verb === "follow" && (
            <div className="flex items-center gap-2 mt-4">
              <button
                ...
                onClick={() => dispatch(followUser(notification.actor_id))}
              >
                Follow Back
              </button>
              <button
                className="px-4 py-2 bg-neutral-200 dark:bg-neutral-700 text-neutral-700 dark:text-neutral-300 rounded-lg hover:bg-neutral-300 dark:hover:bg-neutral-600 transition-colors duration-200"
                onClick={() => navigate(`/u/${notification.actor_id}`)}
              >
                View Profile
              </button>
            </div>
          )}
          {notification.verb === "friend_request" && (
            <button
              className="px-4 py-2 bg-purple-200 dark:bg-purple-700 text-purple-700 dark:text-purple-300 rounded-lg hover:bg-purple-300 dark:hover:bg-purple-600 transition-colors duration-200 mt-4"
              onClick={() => navigate(`/u/${notification.actor_id}`)}
            >
              View Profile
            </button>
