...
const CommentOptions = ({
  ...
  return (
    <>
      <div className="absolute top-4 right-2 bg-white dark:bg-neutral-800 w-56 p-2 rounded-xl shadow-xl border border-gray-200 dark:border-neutral-700 z-30 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          {user?.id == commentOwner.id ? (
            ...
            <>
              <button
                ...
                onClick={() =>
                  dispatch(banUser({ blocked_id: commentOwner.id }))
                }
              >
                <Ban
                  size={18}
      ...
      <div className="w-full max-w-md mx-4 bg-white dark:bg-neutral-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-neutral-700 animate-in zoom-in-95 slide-in-from-bottom-4 duration-300">
        <div className="p-6">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 text-center mb-6">
            ...
            undone and will permanently remove the comment from the
            conversation.
          </p>
